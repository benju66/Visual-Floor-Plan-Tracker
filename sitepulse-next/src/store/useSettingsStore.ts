...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      ...
      mapSettings: { showHorizontalToolbar: true, showCrosshair: false, enableSnapping: true, showWalkSequence: false, smoothWheelZoom: true, sidebarWidth: 320, colorByVariance: false, showMagnifier: false, magnifierZoom: 3, pinnedTools: ['undo', 'redo', 'pan', 'draw', 'add_node'] },
