...
import { Pencil, Copy, FlipHorizontal, FlipVertical, Trash2, RotateCcw, RotateCw, Flag, Activity, History } from 'lucide-react';

export interface CanvasContextMenuProps {
  contextMenu: { x: number; y: number; unitId: string } | null;
  setContextMenu: (m: { x: number; y: number; unitId: string } | null) => void;
  dimensions: { width: number; height: number };
  onRenameUnit?: (id: string) => void;
