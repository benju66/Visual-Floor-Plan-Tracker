...
export function resolveMilestoneColorById(id: number): string {
...
export function resolveMilestoneColorByName(name: string): string {
...
export function milestoneCssVar(id: number): string {
